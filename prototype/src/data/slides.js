export const SLIDES = [
  ...
  // 15. RICE Prioritization
  {
    ...
    rows: [
      [
        'Text-to-Checkout',
        { value: '9', note: 'Not 10 — some users still close deals outside Anchor' },
        { value: '2 — High', note: 'Not Massive — replaces an existing flow, doesn\'t unlock lost revenue' },
        { value: '80%', note: 'Not 90% — client adoption of SMS signing is assumed, not validated' },
        { value: '1', note: 'Not 2 — single request-response, no background jobs' },
        '18.0',
        'P0',
      ],
      [
        ...
        { value: '3 — Massive', note: 'Eliminates asking for money — an emotional barrier, not just friction' },
        { value: '90%', note: 'Mechanically simple; user pain is confirmed across reviews' },
        { value: '2', note: 'Not 1 — needs background scheduler + milestone state machine' },
        '15.0',
        'P1',
      ],
      [
        'Scope Change Alerts',
        { value: '7', note: 'Not 9 — only users with active mid-project scope changes' },
        { value: '3 — Massive', note: 'Unbilled scope = pure revenue loss, often 10–30% of project value' },
        { value: '50%', note: 'Unclear if AI reliably detects intent; client SMS approval unvalidated' },
        { value: '4', note: 'NLP intent + contract diff + client approval flow + audit trail' },
        '4.2',
        'P2',
      ],
      [
        'Auto-Invoicing from Notes',
        { value: '8', note: 'Not 10 — many freelancers already use dedicated time-trackers' },
        { value: '1 — Medium', note: 'Saves admin time but doesn\'t directly recover lost revenue' },
        { value: '50%', note: 'Parsing errors could cause billing mistakes, eroding trust quickly' },
        { value: '2', note: 'Not 1 — text parsing + categorisation against active line items' },
        '2.8',
        'P2',
      ],
    ],
