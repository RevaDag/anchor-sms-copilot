  ...
  // 24b. KPIs — Part 2
  {
    ...
    items: [
      ...
      },
      {
        ...
        measures: 'What % of Starter subscribers upgrade to a Pro plan within 60 days?',
        why: 'Since there is no free trial, Starter users are paying from day one — conversion to Pro is a true upgrade signal, not a trial-exit event. Low conversion means either the Pro features aren\'t compelling enough or users aren\'t hitting the 50-message cap.',
        target: '>20%',
        targetLabel: 'of Starter subscribers at 60 days',
      },
    ],
  },
